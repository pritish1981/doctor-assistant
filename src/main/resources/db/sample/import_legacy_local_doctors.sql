...
-- Legacy availability (relative dates — 30-minute slots, OPEN status)
INSERT INTO availability (id, doctor_id, slot_start, slot_end, status, created_by, updated_by) VALUES
('d5000000-0000-4000-8000-000000000001', 'c4000000-0000-4000-8000-000000000001', (CURRENT_DATE + INTERVAL '1 day' + TIME '11:00') AT TIME ZONE 'UTC', (CURRENT_DATE + INTERVAL '1 day' + TIME '11:30') AT TIME ZONE 'UTC', 'OPEN', 'legacy-import', 'legacy-import'),
('d5000000-0000-4000-8000-000000000002', 'c4000000-0000-4000-8000-000000000001', (CURRENT_DATE + INTERVAL '1 day' + TIME '11:30') AT TIME ZONE 'UTC', (CURRENT_DATE + INTERVAL '1 day' + TIME '12:00') AT TIME ZONE 'UTC', 'OPEN', 'legacy-import', 'legacy-import'),
('d5000000-0000-4000-8000-000000000003', 'c4000000-0000-4000-8000-000000000001', (CURRENT_DATE + INTERVAL '1 day' + TIME '12:00') AT TIME ZONE 'UTC', (CURRENT_DATE + INTERVAL '1 day' + TIME '12:30') AT TIME ZONE 'UTC', 'OPEN', 'legacy-import', 'legacy-import'),
('d5000000-0000-4000-8000-000000000004', 'c4000000-0000-4000-8000-000000000002', (CURRENT_DATE + INTERVAL '1 day' + TIME '10:00') AT TIME ZONE 'UTC', (CURRENT_DATE + INTERVAL '1 day' + TIME '10:30') AT TIME ZONE 'UTC', 'OPEN', 'legacy-import', 'legacy-import'),
...
('d5000000-0000-4000-8000-000000000007', 'c4000000-0000-4000-8000-000000000003', (CURRENT_DATE + INTERVAL '1 day' + TIME '15:30') AT TIME ZONE 'UTC', (CURRENT_DATE + INTERVAL '1 day' + TIME '16:00') AT TIME ZONE 'UTC', 'OPEN', 'legacy-import', 'legacy-import'),
('d5000000-0000-4000-8000-000000000008', 'c4000000-0000-4000-8000-000000000004', (CURRENT_DATE + INTERVAL '1 day' + TIME '16:00') AT TIME ZONE 'UTC', (CURRENT_DATE + INTERVAL '1 day' + TIME '16:30') AT TIME ZONE 'UTC', 'OPEN', 'legacy-import', 'legacy-import')
ON CONFLICT (id) DO UPDATE SET
